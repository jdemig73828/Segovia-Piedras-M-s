...
// Componente para el nuevo Logotipo de Rutabia (Imagen personalizada)
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] font-sans selection:bg-indigo-100 text-[24px] sm:text-[26px] lg:text-[24px]">
      ...
      {isHeaderSearchOpen && (
          <div className="relative bg-white z-40 border-b border-slate-100 p-4 animate-fade-in shadow-xl">
            <div className="max-w-3xl mx-auto relative">
              ...
              {searchTerm && filteredPlaces.length === 0 && (
                 <p className="mt-2 text-rose-600 text-[12px] font-black uppercase tracking-widest text-center">
          ...
          <div className="fixed inset-0 z-[1500] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fade-in text-slate-900" onClick={() => setShowFavsModal(false)}>
              <div className="bg-white rounded-[3rem] w-full max-w-2xl overflow-hidden shadow-2xl border border-white/20 relative text-slate-800" onClick={e => e.stopPropagation()}>
                <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-fuchsia-50 text-fuchsia-700">
                    ...
                    <button onClick={() => setShowFavsModal(false)} className="p-2 hover:bg-fuchsia-100 hover:text-fuchsia-600 rounded-full transition-all text-fuchsia-300 lg:w-12 lg:h-12 text-slate-800"><X className="w-6 h-6 lg:w-7 lg:h-7" /></button>
                </div>
                                    ...
                                    <div className="flex items-center gap-4 text-slate-800 flex-1">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className={`px-1.5 py-0.5 ${categoryColors[p.category]} text-white rounded text-[7px] font-black uppercase rounded leading-none lg:text-[11px]`}>{p.category}</span>
                                            </div>
