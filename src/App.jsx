...
const App = () => {
  ...
  const allPlaces = useMemo(() => [
    ...
    { id: 91, name: "FÁBRICA DE PASTA DE PAPEL", category: "Industrial", coords: "40°55'58.0\"N 4°04'19.0\"W", address: "PALAZUELOS DE ERESMA", note: "Compleplejo industrial movido por las aguas del río Eresma." },
  ...
  const PaginationControls = () => (
    <div className="flex items-center gap-2 text-slate-800">
        ...
        <button 
            ...
            className="p-3 rounded-lg bg-white border border-slate-200 text-slate-400 disabled:opacity-30 hover:bg-slate-50 transition-all w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-slate-800 text-slate-800"
        >
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] font-sans selection:bg-indigo-100 text-[24px] sm:text-[26px] lg:text-[24px]">
      <header className="sticky top-0 z-[1000] h-16 bg-white px-4 md:px-6 flex items-center justify-between border-b border-slate-100 shadow-sm overflow-visible text-slate-800 text-slate-800">
          ...
          <div className="fixed inset-0 z-[2000] bg-black/60 backdrop-blur-md flex justify-end animate-fade-in" onClick={() => setIsSideMenuOpen(false)}>
              <div className="w-[85%] max-w-[320px] bg-white h-full shadow-2xl flex flex-col p-8 pt-4 slide-in-right text-slate-800" onClick={e => e.stopPropagation()}>
                  <div className="flex items-center gap-3 mb-6 pb-6 border-b border-slate-100">
                      ...
                      <h2 className="text-xl font-black tracking-tight text-slate-900 uppercase italic leading-none text-slate-900 text-slate-900">Rutabia</h2>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 flex-1 text-slate-800">
                      ...
                      >
                          <div className="w-8 flex justify-center flex-shrink-0 text-[#4338ca] group-hover:text-white transition-colors">
                            <Route className="w-7 h-7 text-[#4338ca]" />
                          </div>
                      ...
                      >
                          <div className="w-8 flex justify-center flex-shrink-0 text-[#4338ca] group-hover:text-white transition-colors">
                            <Shuffle className="w-7 h-7 text-[#4338ca]" />
                          </div>
      ...
      <section className="relative min-h-[340px] flex flex-col items-center justify-center text-center overflow-visible bg-[#5b21b6] px-6 pt-12 pb-8 bg-[#5b21b6]">
        ...
        <div className="relative z-10 w-full max-w-4xl flex flex-col items-center text-white">
          ...
          <p className="text-white text-[14px] md:text-[16px] lg:text-[18px] mb-10 opacity-90 tracking-wide font-light max-w-2xl mx-auto text-balance text-white/90">
            <span className="font-black text-white text-white text-white text-white">Descubre</span> parajes sorprendentes en <span className="font-black text-white text-white">Segovia</span>
          </p>

          <div className="bg-white/10 backdrop-blur-md rounded-[2.5rem] p-8 border border-white/20 shadow-2xl relative text-slate-800 text-slate-800">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-slate-800 text-slate-800">
                <div className="relative w-full sm:w-auto text-left text-slate-800">
                    ...
                    className="w-full sm:w-[220px] flex items-center justify-between gap-6 px-6 py-4 bg-white rounded-2xl shadow-xl hover:scale-105 transition-all group text-slate-800 text-slate-800 text-slate-800"
                    >
                ...
                <div className="flex flex-col items-center gap-2">
                    {filteredPlaces.length === 0 ? (
                        ...
                        <button 
                          ...
                          className="text-[14px] md:text-[16px] tracking-tight text-fuchsia-400 font-black bg-black/40 px-6 py-2 rounded-full border border-white/10 shadow-inner hover:scale-105 active:scale-95 transition-all text-fuchsia-400"
                        >
          ...
          <div className="w-full max-w-4xl mt-12 flex justify-center gap-x-2 sm:gap-x-8 px-4 text-white text-white">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-2.5 flex-1 sm:flex-none text-center">
                  ...
                  <span className="text-[9px] md:text-[14px] font-medium tracking-wide">Generado con Google Maps</span>
              </div>
          </div>
        </div>
      </section>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 pt-12 text-center min-h-[600px]">
                ...
                <div className="relative z-10 flex flex-col h-full text-slate-800 text-slate-800">
                  <div className={`relative h-52 w-full rounded-[1.8rem] overflow-hidden mb-6 flex items-center justify-center ${categoryVisualBgs[p.category]} shadow-inner`}
                    ...
                    <div className="absolute bottom-5 left-6 z-20 flex flex-col items-start gap-2">
                      ...
                      <div className="px-2.5 py-1 bg-white/95 rounded-lg border border-white shadow-sm text-slate-900 font-bold font-bold font-bold"><p className="text-[10px] font-mono leading-none">{p.coords}</p></div>
                    </div>
                  </div>
                  <div className="px-3 flex-grow flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-[9px] text-slate-400 font-bold uppercase mb-4 flex items-center gap-1.5 leading-none text-slate-400 text-slate-400 text-slate-400"><MapPin className="w-3 h-3 text-[#4338ca]" /> {p.address}</p>
                    ...
                    <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(p.coords)}`} target="_blank" rel="noopener noreferrer" className="bg-black text-white py-3.5 rounded-2xl font-black text-[12px] text-center shadow-lg hover:bg-[#4338ca] transition-all block active:scale-95 leading-none text-white text-white text-white">Ver sitio</a>
                  </div>
                </div>
            </div>
          ))}
        ...
        <div className="col-span-full w-screen relative -ml-[50vw] left-1/2 h-[180px] flex items-center justify-center overflow-hidden shadow-inner bg-cover bg-center group"
            ...
            <div className="absolute top-0 left-0 right-0 h-6 bg-gradient-to-b from-black/80 to-transparent pointer-events-none text-white text-white text-white text-white text-white text-white"></div>
      ...
      <footer className="relative bg-[#111827] py-20 px-6 overflow-hidden text-center border-t border-white/5 text-slate-300">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-balance">
          <div className="bg-[#1f2937]/95 backdrop-blur-2xl rounded-[3rem] p-10 md:p-14 border border-white/10 shadow-2xl mb-12 text-slate-300 text-slate-300 text-slate-300">
            ...
            <h3 className="text-3xl md:text-5xl uppercase italic tracking-tighter leading-none mb-5 text-white text-white text-white">
            ...
            <div className="space-y-6">
              <p className="text-white/40 text-[14px] md:text-[16px] lg:text-[18px] leading-relaxed max-w-lg mx-auto tracking-wide font-light italic text-balance text-white/60 text-white/60 text-white/60">
                <span className="font-black text-white text-white text-white text-white text-white">Descubre</span> parajes sorprendentes en <span className="font-black text-white text-white text-white">Segovia</span>
              </p>
              ...
              <div className="text-white/30 text-[12px] md:text-[14px] flex flex-wrap justify-center gap-x-8 gap-y-2 mb-8 font-medium text-slate-400 text-slate-400 text-slate-400">
                ...
                <span className="hover:text-white transition-colors cursor-pointer text-slate-400 text-slate-400 text-slate-400 text-slate-400 text-slate-400 text-slate-400 text-slate-400 text-slate-400">Términos y Condiciones</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 transition-opacity opacity-60 hover:opacity-100 text-slate-400 text-slate-400 text-slate-400 text-slate-400">
                ...
                <p className="text-white/40 text-[9px] font-bold uppercase tracking-[0.2em] text-white/40 text-white/40 text-white/40 text-white/40">Powered By Google Maps</p>
              </div>
            </div>
          </div>
      ...
      {showFavsModal && (
          <div className="fixed inset-0 z-[1500] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fade-in text-slate-900" onClick={() => setShowFavsModal(false)}>
              <div className="bg-white rounded-[3rem] w-full max-w-2xl overflow-hidden shadow-2xl border border-white/20 relative text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800" onClick={e => e.stopPropagation()}>
                <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-fuchsia-50 text-fuchsia-700 text-fuchsia-700 text-fuchsia-700">
                    <h4 className="font-black uppercase italic text-fuchsia-700 flex items-center gap-2 leading-none lg:text-[22px] lg:text-[26px] font-black text-fuchsia-700 text-fuchsia-700 text-fuchsia-700"><Heart className="w-5 h-5 fill-current lg:w-7 lg:h-7 lg:w-9 lg:h-9" /> Crear ruta</h4>
                ...
                <div className="p-8 space-y-4 overflow-y-auto max-h-[60vh] text-left text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                    {favPlacesWithDist.length === 0 ? (
                        <div className="text-center py-20 text-slate-400 text-slate-400 text-slate-400 text-slate-400 text-slate-400 text-slate-400 text-slate-400">
                            ...
                            <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px] lg:text-[14px] lg:text-[18px] text-slate-400 text-slate-400">No has guardado parajes aún</p>
                        </div>
                    ) : (
                      <>
                        {favPlacesWithDist.map((p, idx) => (
                            <div key={p.id} className="relative text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                                ...
                                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-white transition-all shadow-sm text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                                    <div className="flex items-center gap-4 text-slate-800 flex-1 text-slate-800 text-slate-800 text-slate-800">
                                        <div className={`w-3 h-10 rounded-full flex-shrink-0 ${categoryColors[p.category]}`}></div>
                                        <div>
                                            <div className="flex items-center gap-2 mb-1 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                ...
                <div className="p-6 bg-slate-50 border-t border-slate-100 text-center">
                    <p className="text-[9px] uppercase tracking-widest font-bold text-slate-400 lg:text-[13px] lg:text-[17px] text-slate-400 text-slate-400 text-slate-400">{favorites.length} parajes seleccionados</p>
                </div>
          ...
          <div className="fixed inset-0 z-[1500] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fade-in text-slate-900" onClick={() => setRandomPlace(null)}>
              <div className="bg-white rounded-[3rem] w-full max-w-lg overflow-hidden shadow-2xl border border-white/20 p-10 text-center relative text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800" onClick={e => e.stopPropagation()}>
                <button 
                    ...
                    className="absolute top-6 right-6 p-2 hover:bg-indigo-50 hover:text-indigo-600 rounded-full transition-all text-slate-400 z-10 font-black text-slate-400 text-slate-400 text-slate-400 text-slate-400"
                >
                ...
                <p className="text-slate-500 italic text-sm mb-10 leading-relaxed lg:text-[18px] lg:text-[22px] text-slate-500 text-slate-500 text-slate-500 text-slate-500 text-slate-500 text-slate-500">"{randomPlace.note}"</p>
                <div className="flex flex-col gap-3">
                    <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(randomPlace.coords)}`} 
                       target="_blank" 
                       rel="noopener noreferrer" 
                       className="bg-black text-white py-4 px-10 rounded-2xl font-black text-[14px] shadow-xl hover:scale-105 transition-all lg:text-[16px] lg:text-[20px] flex items-center justify-center gap-3 text-white text-white text-white text-white">
                      <img src="https://www.gstatic.com/images/branding/product/2x/maps_96dp.png" alt="G" className="h-4 w-auto lg:h-6 text-white text-white text-white text-white text-white" />
                      Ver sitio
                    </a>
              ...
              <div className="bg-white rounded-[3rem] w-full max-w-2xl overflow-hidden shadow-2xl border border-white/20 relative text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-8 space-y-6 overflow-y-auto max-h-[65vh] pb-12 text-left text-slate-800 text-slate-800 text-slate-800">
                    {itinerary.places.map((p, idx) => (
                        <div key={p.id} className="relative text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                            {p.kmFromPrev && (
                                <div className="flex flex-col items-center -mt-6 mb-4 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                            ...
                            <div className="flex gap-4 items-start p-4 bg-slate-50 rounded-2xl border border-slate-100 shadow-sm text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                                <div className="bg-indigo-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-black flex-shrink-0 text-xs lg:w-10 lg:h-10 lg:text-[14px] text-white text-white text-white">
                                  {idx + 1}
                                </div>
                                <div className="flex-grow text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                                    <div className="flex items-center gap-2 mb-1 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800 text-slate-800">
                                        <h5 className="font-black uppercase text-sm leading-tight lg:text-[18px] text-slate-800 font-black text-slate-800 text-slate-800">{p.name}</h5>
                                        <span className={`px-1.5 py-0.5 ${categoryColors[p.category]} text-white rounded text-[7px] font-black uppercase leading-none lg:text-[11px]`}>{p.category}</span>
                                    </div>
                    ...
                    <div className="pt-6 border-t border-slate-100 mt-8 pb-10 px-4 text-center">
                        <a href={`https://www.google.com/maps/dir/?api=1&origin=${encodeURIComponent(itinerary.places[0].coords)}&destination=${encodeURIComponent(itinerary.places[itinerary.places.length-1].coords)}${itinerary.places.length > 2 ? `&waypoints=${encodeURIComponent(itinerary.places[1].coords)}` : ''}&travelmode=driving`} target="_blank" rel="noopener noreferrer" className="w-full bg-black text-white py-5 rounded-2xl font-black text-xs text-center uppercase tracking-[0.2em] shadow-xl hover:bg-indigo-900 transition-all flex items-center justify-center gap-3 active:scale-95 mb-10 text-white lg:text-[16px] font-black text-white text-white text-white text-white text-white text-white"><img src="https://www.gstatic.com/images/branding/product/2x/maps_96dp.png" alt="G" className="h-4 w-auto lg:h-6" />Ver ruta</a>
                        
                        <button 
                            onClick={() => setItinerary(null)} 
                            className="mt-6 text-slate-400 hover:text-indigo-600 text-[11px] font-black uppercase tracking-widest transition-colors lg:text-[15px] font-black text-slate-400 text-slate-400 text-slate-400"
                        >
                            Cerrar
                        </button>
                    </div>
      ...
      {showScrollBtn && <button onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})} className="fixed bottom-8 right-8 z-[100] w-14 h-14 bg-black text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all border border-white/10 text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white"><ArrowUp className="w-6 h-6" /></button>}
