...
const App = () => {
  ...
  const allPlaces = useMemo(() => [
    { id: 1, name: "ERMITA DE SAN JUAN", category: "Historia", coords: "41°21'33.4\"N 3°51'16.9\"W", address: "VALLE DE TABLADILLO", note: "Pequeño oratorio románico oculto en el profundo valle de tabladillo.", image: "https://lh3.googleusercontent.com/d/1WCfuaYRzGZqH5G7C-ll8qwjD3jJ_3TGU" },
    { id: 2, name: "CONVENTO DE SANTA ISABEL", category: "Historia", coords: "40°43'03.6\"N 4°14'51.2\"W", address: "EL ESPINAR", note: "Restos históricos del convector del s. XVI de las monjas clarisas.", image: "https://lh3.googleusercontent.com/d/1lvGNMFGnOYRnWIeWAGF1vIpP0rZa6X6I" },
    { id: 3, name: "FORTALEZA CASTILLO", category: "Historia", coords: "41°21'13.6\"N 3°53'15.2\"W", address: "CARRASCAL DEL RÍO", note: "Fortaleza dominante sobre el paisaje de las hoces del río Duratón.", image: "https://lh3.googleusercontent.com/d/1jjPYi12uwmW6lkJ5IRBSs1_4WEexX9Ki" },
    ...
    { id: 5, name: "PUERTA DE LA FUERZA", category: "Historia", coords: "41°18'09.1\"N 3°45'31.9\"W", address: "SEPÚLVEDA", note: "Acceso amurallado histórico de la villa medieval.", image: "https://lh3.googleusercontent.com/d/1OZa8PL2j7CcIsOH4NEBCIz9OmkpAjs3t" },
    { id: 6, name: "PESQUERÍAS REALES", category: "Historia", coords: "40°53'25.4\"N 4°01'20.6\"W", address: "VALSAÍN", note: "Senda regia empedrada construida junto al cauce del río Eresma.", image: "https://lh3.googleusercontent.com/d/1MtKo8q6S2ILL5XmEaC9yKwVRT5fve2u4" },
    { id: 7, name: "PALACIO REAL DE VALSAÍN", category: "Historia", coords: "40°52'36.9\"N 4°01'36.3\"W", address: "VALSAÍN", note: "Ruinas del antiguo palacio de recreo de los Austrias.", image: "https://lh3.googleusercontent.com/d/1IKe1F44JNzFjmxz2rs0sjQufLnuA5Jxp" },
    { id: 8, name: "CASA ERASO", category: "Historia", coords: "40°48'22.3\"N 4°03'07.3\"W", address: "VALSAÍN", note: "Edificación ligada históricamente a la gestión de montes y caza real.", image: "https://lh3.googleusercontent.com/d/1RxBEUNb82S4_zNPbsMEvgAuXow_vw9Wu" },
    ...
    { id: 10, name: "ESTACIÓN APEADERO DE TREN", category: "Industrial", coords: "41°30'10.5\"N 3°32'34.7\"W", address: "MADERUELO", note: "Antigua parada de la línea ferroviaria que conectaba la zona mística.", image: "https://lh3.googleusercontent.com/d/1i5sluqM4dAaPI40ujn5WZ3fGnYWjFePD" },
    ...
    { id: 12, name: "FÁBRICA DE HARINA MARTÍNEZ", category: "Industrial", coords: "41°13'14.8\"N 4°10'27.6\"W", address: "FUENTEPELAYO", note: "Antiguo complejo harinero representativo de la comarca.", image: "https://lh3.googleusercontent.com/d/1PG5kep4K3V9JkNpVzZI7d4SK_3is_7JR" },
    { id: 13, name: "PALACIO DE LOS MARQUESES DE AGUILAFUENTE", category: "Historia", coords: "41°13'47.7\"N 4°06'54.3\"W", address: "AGUILAFUENTE", note: "Residencia señorial histórica de gran relevancia arquitectónica.", image: "https://lh3.googleusercontent.com/d/1a8uY_vROaohrgVuBGKo2AcoKd05jHUUX" },
    { id: 14, name: "TELÉGRAFO ÓPTICO", category: "Industrial", coords: "41°08'44.9\"N 4°37'36.4\"W", address: "TOLOCIRIO", note: "Torre de comunicación del siglo XIX perteneciente a la línea de Castilla.", image: "https://lh3.googleusercontent.com/d/1xe8DywAL6XKb6vgSqnaNxxPdBqBGOsP5" },
    ...
    { id: 16, name: "FÁBRICA DE HARINA", category: "Industrial", coords: "41°09'36.1\"N 4°29'19.1\"W", address: "NAVA DE LA ASUNCIÓN", note: "Patrimonio industrial ligado a la explotación cerealista.", image: "https://lh3.googleusercontent.com/d/1DlZZuZN6WXIxVJJLp65_ecvtyCx44n9V" },
    { id: 17, name: "ERMITA DE SANTA ROSALÍA", category: "Historia", coords: "41°13'21.1\"N 4°31'21.2\"W", address: "COCA", note: "Edificación religiosa situada en el entorno histórico de la villa de Coca.", image: "https://lh3.googleusercontent.com/d/1XLedTWcwuFa-1PxRVboN1NATLCZWX_l3" },
    { id: 18, name: "ERMITA DE SAN ANDRÉS", category: "Historia", coords: "41°15'25.8\"N 4°09'45.2\"W", address: "ZARZUELA DEL PINAR", note: "Templo románico rodeado de la inmensidad de los pinares.", image: "https://lh3.googleusercontent.com/d/1e--4FL9WEGKXPtCn3H4SK-LIpIMXQy66" },
    { id: 19, name: "ERMITA DE SAN CEBRIÁN", category: "Historia", coords: "41°15'00.0\"N 4°12'36.7\"W", address: "ZARZUELA DEL PINAR", note: "Pequeño santuario medieval en el corazón de Tierra de Pinares.", image: "https://lh3.googleusercontent.com/d/1W_Op0OqZQvIdSr0uWO9SxzounioDMma0" },
    { id: 20, name: "MOLINO DE MINGELA", category: "Industrial", coords: "41°22'40.9\"N 4°25'54.4\"W", address: "VALLELADO", note: "Antiguo molino situado en la margen del río Cega.", image: "https://lh3.googleusercontent.com/d/1EbRaQZt_Jr-pPUftGnimylMmatAEBM7s" },
    { id: 21, name: "MOLINO DE POTRICOS", category: "Industrial", coords: "41°24'02.7\"N 4°07'27.2\"W", address: "PEROSILLO", note: "Ingenio hidráulico histórico preservado en el paisaje rural.", image: "https://lh3.googleusercontent.com/d/1dD6MkgWzbVtDkUd57LC2z1ZJ5cx_sgv7" },
    { id: 22, name: "MOLINO DEL PINO", category: "Industrial", coords: "41°23'11.3\"N 4°28'40.2\"W", address: "MATA DE CUÉLLAR", note: "Molino harinero tradicional de construcción en piedra.", image: "https://lh3.googleusercontent.com/d/1QHfZI8SSmgCvXLqL8xfqfGIW4j1QidyZ" },
    { id: 23, name: "TORREÓN DE SANTA MARÍA", category: "Historia", coords: "41°24'00.1\"N 4°13'24.6\"W", address: "LOVINGOS", note: "Restos de la torre de la antigua iglesia parroquial.", image: "https://lh3.googleusercontent.com/d/12-tiwbmOPXc99pjF9KBSKngNudN5q3j2" },
    { id: 24, name: "MOLINO BATÁN DE GARRIDO", category: "Industrial", coords: "41°17'01.9\"N 4°08'49.1\"W", address: "LASTRAS DE CUÉLLAR", note: "Antiguo batán utilizado para el tratamiento de tujeidos.", image: "https://lh3.googleusercontent.com/d/1mQd-aSaoONOTkJ1Z4o3PHmx8-YOVFJ-5" },
    { id: 25, name: "MOLINO DEL LADRÓN", category: "Industrial", coords: "41°17'24.8\"N 4°09'04.2\"W", address: "LASTRAS DE CUÉLLAR", note: "Construcción hidráulica ssingular en la ribera del cega.", image: "https://lh3.googleusercontent.com/d/1rLaLeQSbbgjDax94O9AtK95YUK-aXqch" },
    { id: 26, name: "FÁBRICA DE HARINA", category: "Industrial", coords: "41°20'52.1\"N 4°07'09.3\"W", address: "HONTALBILLA", note: "Instalación industrial cerealista de principios del siglo XX.", image: "https://lh3.googleusercontent.com/d/15YNrBNAkxC31UZTGjTZzN-cejyDL_jPl" },
    { id: 27, name: "IGLESIA DE SAN JUAN BAUTISTA", category: "Historia", coords: "41°24'52.2\"N 4°12'55.3\"W", address: "FUENTES DE CUÉLLAR", note: "Templo que destaca por su volumetría y elementos arquitectónicos.", image: "https://lh3.googleusercontent.com/d/1jQ7IcxvU5BOpUnE50rk5H-7nu-dluzfX" },
    { id: 28, name: "MOLINO DE ALVARADO", category: "Industrial", coords: "41°18'36.8\"N 4°27'30.9\"W", address: "FRESNEDA DE CUÉLLAR", note: "Maquinaria e ingenio harinero típico de la comarca cuellarana.", image: "https://lh3.googleusercontent.com/d/196qwJ5Sp-_mAmg42vR1RvSLqk7lKKGqb" },
    { id: 29, name: "IGLESIA DE SAN BARTOLOMÉ DE POCIAGUE", category: "Ruinas", coords: "41°26'57.6\"N 4°16'22.6\"W", address: "ESCARABAJOSA DE CUÉLLAR", note: "Restos de la iglesia del antiguo despoblado de Pociague.", image: "https://lh3.googleusercontent.com/d/1Z-NWGVzsP-RYlb5JTWpLwVH7_V8w6af7" },
    { id: 30, name: "MONASTERIO DE SAN FRANCISCO", category: "Historia", coords: "41°24'07.6\"N 4°18'37.0\"W", address: "CUÉLLAR", note: "Cuna del gótico isabelino y panteón de los Duques de Alburquerque.", image: "https://lh3.googleusercontent.com/d/1eHL9GxGO6sKntKQPfcBcMtwPXl2B5b0T" },
    { id: 31, name: "CONVENTO DE LA SANTÍSIMA TRINIDAD", category: "Historia", coords: "41°23'57.8\"N 4°18'54.4\"W", address: "CUÉLLAR", note: "Antiguo establecimiento religioso de los padres trinitarios.", image: "https://lh3.googleusercontent.com/d/1gczcmUZ8iR2HtOvawczkhSiQK91V8UWE" },
    { id: 32, name: "ERMITA DE SAN BENITO", category: "Historia", coords: "41°22'18.3\"N 4°07'20.5\"W", address: "ADRADOS", note: "Lugar de culto histórico en las proximidades del municipio.", image: "https://lh3.googleusercontent.com/d/1EPuJsSoudLaK7wCuGd_Vqe8J6QzEeTFo" },
    { id: 33, name: "CERRO DE LAS SERVITONAS", category: "Ruinas", coords: "41°24'19.4\"N 3°57'16.6\"W", address: "SAN MIGUEL DE BERNUY", note: "Asentamiento antiguo con vistas panorámicas al valle del Duratón.", image: "https://lh3.googleusercontent.com/d/1eMRMnqamFzkjKumgrb5Zvfb4lQAN5w7W" },
    { id: 34, name: "MOLINO DE ABAJO Y MOLINO DE ENMEDIO", category: "Industrial", coords: "41°27'02.8\"N 4°04'53.0\"W", address: "MEMBRIBRE DE LA HOZ", note: "Conjunto hidráulico harinero en un entorno natural encajonado.", image: "https://lh3.googleusercontent.com/d/1mKujIXqs52VdyAY2Gg-Jzqf2JZzwkVLf" },
    { id: 35, name: "MURALLA Y CASTILLO", category: "Historia", coords: "41°26'21.0\"N 3°58'40.6\"W", address: "FUENTIDUEÑA", note: "Importante conjunto defensivo medieval sobre el cerro.", image: "https://lh3.googleusercontent.com/d/1SbMn-jo5QWY_zgqpWk-MEH_FF1Xw2Tnk" },
    { id: 36, name: "LINARES DEL ARROYO", category: "Ruinas", coords: "41°31'24.9\"N 3°33'23.9\"W", address: "MADERUELO", note: "Pueblo sumergido bajo las aguas del embalse de Linares.", image: "https://lh3.googleusercontent.com/d/1iwQkBBFxP1mvGeL0F3M3NRxaJ-rW6pAd" },
    ...
    { id: 39, name: "ERMITA DE SAN MIGUEL", category: "Historia", coords: "41°29'48.6\"N 3°57'55.2\"W", address: "SACRAMENIA", note: "Joya del románico rural segoviano en un paraje solitario.", image: "https://lh3.googleusercontent.com/d/1lbhTCSL2t76zDiQ5z3c3Yb3CzUL6bZiY" },
    { id: 40, name: "PALACIO DE LOS CONTRERAS", category: "Historia", coords: "41°29'38.0\"N 4°01'42.0\"W", address: "LAGUNA DE CONTRERAS", note: "Palacio fortificado que conserva su aire de dominio medieval.", image: "https://lh3.googleusercontent.com/d/1LfppuKioxZiimm32lN045zKBs6DQkcgs" },
    { id: 41, name: "IGLESIA CONVENTO DE SAN MARTÍN DEL CASUAR", category: "Ruinas", coords: "41°32'44.7\"N 3°35'59.6\"W", address: "MONTEJO DE LA VEGA", note: "Restos del monasterio románico en las Hoces del Riaza.", image: "https://lh3.googleusercontent.com/d/1ywsiybCQi2PzLeXzXmiSxd0-pNKKecx0" },
    { id: 42, name: "CASTILLO Y MURALLAS", category: "Historia", coords: "41°33'03.9\"N 3°39'16.6\"W", address: "MONTEJO DE LA VEGA", note: "Antigua fortificación defensiva del nordeste segoviano.", image: "https://lh3.googleusercontent.com/d/1CKuRQa2vOhZ-iPQidh_Cy3hZGJmxoLde" },
    { id: 43, name: "CASERÍO DE MALUQUE", category: "Ruinas", coords: "41°33'08.3\"N 3°33'17.3\"W", address: "MADERUELO", note: "Asentamiento abandonado que conserva la estructura tradicional.", image: "https://lh3.googleusercontent.com/d/1FfAATGf-09Y5ecwlaH5IE2LPDsJJK5-w" },
    ...
    { id: 45, name: "LOS PAREDONES", category: "Ruinas", coords: "41°25'16.0\"N 3°22'23.9\"W", address: "AYLLÓN", note: "Vestigios de antiguas construcciones defensivas de tierra batida.", image: "https://lh3.googleusercontent.com/d/1A7aToJgyRJmR-TU2UbMnD4YdKDduXBUg" },
    { id: 46, name: "IGLESIA DE SAN MIGUEL ARCÁNGEL", category: "Historia", coords: "41°20'53.2\"N 3°24'31.7\"W", address: "ALDEA LÁZARO RIBOTA", note: "Parroquia medieval destacada en su entorno rural.", image: "https://lh3.googleusercontent.com/d/1Jc-7YhCcP3ylaz8AjL_oM4bEICSp9RAz" },
    ...
    { id: 48, name: "IGLESIA DE SAN JUAN", category: "Historia", coords: "41°23'06.5\"N 3°31'53.6\"W", address: "CASTILTIERRA", note: "Iglesia ligada a la famosa necrópolis visigoda de Castiltierra.", image: "https://lh3.googleusercontent.com/d/1C2hX5H2DYkw09-MZ9LesJ2kp0vfxbBlj" },
    { id: 49, name: "IGLESIA DE SAN ANTONIO", category: "Historia", coords: "41°20'12.7\"N 3°32'39.4\"W", address: "ALDEANUEVA DEL MONTE", note: "Muestra arquitectónica religiosa del área de influencia de Riaza.", image: "https://lh3.googleusercontent.com/d/1lTjM9mSWXreZpGxWflIifU6LGy1nTMXr" },
    { id: 50, name: "LA MOLINILLA Y ERMITA DE LA VIRGEN DE LA CALLEJA", category: "Historia", coords: "41°17'52.6\"N 3°51'59.6\"W", address: "VILLASECA", note: "Paraje místico cercano a las hoces del río Duratón.", image: "https://lh3.googleusercontent.com/d/1JQVETziB4Xc5S_BQI_rKCoGQkcy6L4JB" },
    { id: 51, name: "MONASTERIO DE SANTO TOMÉ DEL PUERTO", category: "Ruinas", coords: "41°11'56.8\"N 3°35'24.7\"W", address: "VILLAREJO", note: "Restos monásticos situados estratégicamente en el puerto.", image: "https://lh3.googleusercontent.com/d/1xnG9rFZoqzc_5cm1aqMHH6-7ywaVLt9D" },
    { id: 52, name: "IGLESIA DE NUESTRA SEÑORA DE LA SERNA", category: "Historia", coords: "41°16'02.5\"N 3°43'05.9\"W", address: "VELOSILLO", note: "Edificación románica de gran encanto en el altiplano segoviano.", image: "https://lh3.googleusercontent.com/d/163iWMzqlS-X6KBnJh48UO-0tTcgfWuRg" },
    { id: 53, name: "MOLINO DE SAN JUAN", category: "Historia", coords: "41°15'52.9\"N 3°50'53.2\"W", address: "VALDESIMONTE", note: "Molino harinero restaurado que aprovecha el cauce del San Juan.", image: "https://lh3.googleusercontent.com/d/1edd3MOzUimD7S20ZvTGhkRomxZiPEMOG" },
    { id: 54, name: "LAVADERO DE LANAS DE LA ALDEA LA PEÑA", category: "Industrial", coords: "41°12'17.8\"N 3°37'20.7\"W", address: "SIGUERO", note: "Muestra de la antigua importancia de la trashumancia y el esquileo.", image: "https://lh3.googleusercontent.com/d/1MLaScPwj4KYMxV4P0_avJqWvqoH4nmxA" },
    { id: 55, name: "MOLINO DE LA OCECILLA", category: "Industrial", coords: "41°18'37.0\"N 3°43'45.2\"W", address: "SEPÚLVEDA", note: "Maquinaria hidráulica tradicional en el entorno de la villa sepulvedana.", image: "https://lh3.googleusercontent.com/d/1-qBgKwHaTeho3jys8ZLHj9HJlGQ5nt6T" },
    { id: 56, name: "IGLESIA DE SAN MILLÁN", category: "Historia", coords: "41°18'03.3\"N 3°44'57.0\"W", address: "SEPÚLVEDA", note: "Antiguo templo que forma parte del conjunto monumental de Sepúlveda.", image: "https://lh3.googleusercontent.com/d/1X1pHpX6gCtgCgxIufWHIymtRDEkK25x4" },
    { id: 57, name: "PALACIO Y DESPOBLADO DE SAN MIGUEL DE NEGUERA", category: "Ruinas", coords: "41°16'49.5\"N 3°50'32.9\"W", address: "SEBÚLCOR", note: "Villa señorial abandonada a orillas del Duratón.", image: "https://lh3.googleusercontent.com/d/14HiCAZwiaZslTGjmH-MfMMDAw7VZ55uz" },
    { id: 58, name: "CONVENTO DE LA HOZ", category: "Ruinas", coords: "41°18'49.5\"N 3°52'19.5\"W", address: "SEBÚLCOR", note: "Impresionantes ruinas monásticas sobre el cauce del Duratón.", image: "https://lh3.googleusercontent.com/d/1Q3UOjhQM1uCRX8oy8VNrtK4YwJm5wk4Q" },
    { id: 59, name: "ERMITA DE SANTIAGO DE REBOLLO", category: "Historia", coords: "41°12'30.7\"N 3°48'46.6\"W", address: "SAN PEDRO DE GAÍLLOS", note: "Santuario rural de devoción popular local.", image: "https://lh3.googleusercontent.com/d/187gB6opmiO9vtxvzV8NbCVhT_xoxCVEM" },
    { id: 60, name: "PALACIO DEL MARQUÉS REVILLA", category: "Historia", coords: "41°24'49.5\"N 3°45'03.6\"W", address: "NAVARES DE LAS CUEVAS", note: "Grandeza señorial en una de las comarcas más auténticas de Segovia.", image: "https://lh3.googleusercontent.com/d/12uKyhI3ErQP10GR2XErSRT_csZReiAPW" },
    { id: 61, name: "DESPOBLADO DE MATANDRINO", category: "Ruinas", coords: "41°09'00.5\"N 3°42'37.0\"W", address: "PRÁDENA", note: "Aldea deshabitada que conserva el alma de la Segovia de antaño.", image: "https://lh3.googleusercontent.com/d/1XPVZN6TAuTo--zY4FC2dTCx4Fk7j1TDw" },
    { id: 62, name: "IGLESIA DE SAN MIGUEL", category: "Historia", coords: "41°20'37.6\"N 3°51'58.6\"W", address: "FRESNEDA DE SEPÚLVEDA", note: "Parroquia rural de origen medieval en la tierra de Sepúlveda.", image: "https://lh3.googleusercontent.com/d/1Rg7F2ZgWqBPWwi7rTTGljSm2gWI1O9Es" },
    { id: 63, name: "DESPOBLADO DE VILLAREJO", category: "Ruinas", coords: "41°17'54.7\"N 3°40'32.6\"W", address: "EL OLMO", note: "Vestigios de un antiguo nucleus de población hoy desaparecido.", image: "https://lh3.googleusercontent.com/d/1xEgzzG9q8rzw0Sn3gZMDgGRd32SvqZtY" },
    { id: 64, name: "DESPOBLADO DE CORRALEJO", category: "Ruinas", coords: "41°17'46.5\"N 3°38'34.4\"W", address: "EL OLMO", note: "Huellas de la historia rural en el campo segoviano.", image: "https://lh3.googleusercontent.com/d/1MBHc6_84V_F6W7RSM0QxvZZm6gwqP_As" },
    { id: 65, name: "ERMITA DE SAN LORENZO", category: "Historia", coords: "41°19'25.0\"N 3°42'12.3\"W", address: "EL OLMILLO", note: "Pequeño templo románico de gran sencillez y belleza.", image: "https://lh3.googleusercontent.com/d/1kraCFHblo2uPaOLB7TYKGLwk1V7TKQWJ" },
    { id: 66, name: "CASA PALACIO DE LOS MARQUESES DE CASTROSERNA", category: "Historia", coords: "41°11'23.5\"N 3°42'54.2\"W", address: "CASTROSERNA DE ARRIBA", note: "Edificio señorial representativo de la nobleza segoviana.", image: "https://lh3.googleusercontent.com/d/1gs6tn-KJmGW0TeHxrecWuuX_24IjrNho" },
    { id: 67, name: "ERMITA DE SAN JULIÁN", category: "Historia", coords: "41°17'51.6\"N 3°47'00.3\"W", address: "CASTRILLO DE SEPÚLVEDA", note: "Lugar de culto tradicional en un entorno paisajístico privilegiado.", image: "https://lh3.googleusercontent.com/d/1ebjt4Y8QadYQK3Yfnx7QSGee9kk1TT7L" },
    ...
    { id: 69, name: "FÁBRICA DE RESINA", category: "Industrial", coords: "41°14'12.5\"N 3°55'35.4\"W", address: "CABEZUELA", note: "Patrimonio industrial ligado a la explotación de los pinos.", image: "https://lh3.googleusercontent.com/d/12zGLhYL7f6P0DH-ghZypw4T-UbIYw1lm" },
    { id: 70, name: "MOLINO DE LA CERQUILLA", category: "Industrial", coords: "41°21'48.4\"N 3°49'38.3\"W", address: "BARRIO DE ARRIBA", note: "Ingenio harinero situado en un paraje de gran valor geológico.", image: "https://lh3.googleusercontent.com/d/1n2cZcRTeuiRj4w-iCWD_KbVJfJsgPxXq" },
    { id: 71, name: "DESPOBLADO DE ALDEARRASO", category: "Ruinas", coords: "41°14'06.7\"N 3°48'12.7\"W", address: "SAN PEDRO DE GAÍLLOS", note: "Restos de población en una zona de pastos tradicionales.", image: "https://lh3.googleusercontent.com/d/1K8wtIa_B9tIH1C-7-7V1Ez74y4_nHGuT" },
    { id: 72, name: "ERMITA DE SAN PEDRO", category: "Historia", coords: "41°07'54.4\"N 3°54'39.0\"W", address: "VALDEVACAS Y GUIJAR", note: "Antiguo oratorio rural en un entorno de naturaleza virgen.", image: "https://lh3.googleusercontent.com/d/14R3Yyc3SZI2VZbaPMEGw76EYHdTe3rFn" },
    { id: 73, name: "IGLESIA DE SAN JUSTO Y PASTOR", category: "Historia", coords: "41°05'10.9\"N 3°52'45.0\"W", address: "SANTIUSTE DE PEDRAZA", note: "Parroquia románica destacada por su torre-atalaya.", image: "https://lh3.googleusercontent.com/d/1c0dIR6jzipoKpw3sWqRqpl8mrxDl8smI" },
    ...
    { id: 75, name: "IGLESIA DE SANTA MARÍA", category: "Historia", coords: "41°07'55.0\"N 3°48'45.6\"W", address: "PEDRAZA", note: "Iglesia que preside la famosa plaza mayor de la villa de Pedraza.", image: "https://lh3.googleusercontent.com/d/17OhloPs5OmchYOdBfyeWuyPnutFyi_oD" },
    ...
    { id: 77, name: "DESPOBLADO DE la ALAMEDA", category: "Ruinas", coords: "41°10'09.1\"N 3°46'56.9\"W", address: "LA ALAMEDA", note: "Lugar abandonado que evoca el pasado místico de la zona.", image: "https://lh3.googleusercontent.com/d/17EpvO-gA79FIeScl9jqcfkACfq3KV1Ei" },
    { id: 78, name: "TORREGIL", category: "Historia", coords: "41°04'57.5\"N 3°47'23.0\"W", address: "GALLEGOS", note: "Atalaya defensiva estratégica con amplias vistas de la sierra.", image: "https://lh3.googleusercontent.com/d/1LftSR0G1S5QH6i1_xzs5ucr5cG0A-_nK" },
    { id: 79, name: "MONASTERIO DE SANTA MARÍA DE LA SIERRA", category: "Ruinas", coords: "41°01'37.1\"N 3°54'46.2\"W", address: "COLLADO HERMOSO", note: "Restos cistercienses integrados en el paisaje montañoso.", image: "https://lh3.googleusercontent.com/d/1YxwyU7e_muR1Y90_8hn2opDNuQoe2gI-" },
    { id: 80, name: "ESTACIÓN DE TREN", category: "Industrial", coords: "41°04'28.1\"N 4°16'15.8\"W", address: "YANGUAS DE ERESMA", note: "Arquitectura ferroviaria de principios del siglo XX.", image: "https://lh3.googleusercontent.com/d/1pbt2vAQ5Xw4A1Ll11LwnCJL8iSZ00tVZ" },
    { id: 81, name: "ERMITA DE SAN ANDRÉS", category: "Historia", coords: "40°48'54.8\"N 4°26'47.0\"W", address: "VILLACASTÍN", note: "Templo histórico situado en el cruce de caminos reales.", image: "https://lh3.googleusercontent.com/d/1aiUHlGNtfQiA4bIiWvmwQ_8Z8rSdDdw0" },
    { id: 82, name: "ERMITA DE SANMEDEL", category: "Historia", coords: "41°00'03.8\"N 4°08'27.4\"W", address: "VALSECA", note: "Santuario rural representativo de la devoción agraria.", image: "https://lh3.googleusercontent.com/d/1C3dHCUz1CAZVtNv4OMr-G-IIx1-1nRxZ" },
    ...
    { id: 84, name: "MOLINO DE CAVILA", category: "Industrial", coords: "40°57'16.0\"N 4°06'48.1\"W", address: "SEGOVIA", note: "Ingenio harinero a las afueras de la capital.", image: "https://lh3.googleusercontent.com/d/1eiUAfj-UgPrSl7h2X7P5rTlPGGVUa-i0" },
    { id: 85, name: "FÁBRICA DE TEJAS Y LADRILLOS", category: "Industrial", coords: "40°55'17.6\"N 4°07'31.9\"W", address: "SEGOVIA", note: "Muestra de la industria cerámica tradicional segoviana.", image: "https://lh3.googleusercontent.com/d/1Mc9pW1cYD7eVLUrlMgNr7qNXcG_G7XIC" },
    { id: 86, name: "CONVENTO DE SAN AGUSTÍN", category: "Ruinas", coords: "40°57'03.2\"N 4°07'08.2\"W", address: "SEGOVIA", note: "Restos del antiguo convector extramuros de la ciudad.", image: "https://lh3.googleusercontent.com/d/1HmMcKxYYkAYYu19lIpo7ocwkMVzNnwTW" },
    { id: 87, name: "PALACIO DE LOS MARQUESES DE CASABLANCA", category: "Historia", coords: "41°11'43.3\"N 4°04'01.4\"W", address: "SAUQUILLO DE CABEZAS", note: "Gran residencia nobiliaria en medio de las tierras de cereal.", image: "https://lh3.googleusercontent.com/d/1LNFWA7YIjy8-K4cw7oFPmj5ZW_6MTkr8" },
    { id: 88, name: "RANCHO DE ALFARO", category: "Industrial", coords: "41°00'16.5\"N 3°57'25.1\"W", address: "SANTO DOMINGO DE PIRÓN", note: "Esquileo tradicional y finca ganadera histórica.", image: "https://lh3.googleusercontent.com/d/1lopQOZzR1ZkMsyY09XjxdeXAcinFUkqw" },
    ...
    { id: 96, name: "ERMITA Y CASERÍO DE BERNUY DE PÁRRACES", category: "Historia", coords: "40°54'56.5\"N 4°23'27.3\"W", address: "MARUGÁN", note: "Santuario y asentamiento tradicional segoviano.", image: "https://lh3.googleusercontent.com/d/1M7rXLT_chf5GFEZUG9FAzig65Y2fpU5f" },
    ...
    { id: 99, name: "ERMITA DE SANTA INÉS", category: "Historia", coords: "41°06'46.5\"N 4°19'26.3\"W", address: "BERNARDOS", note: "Capilla románica rodeada de las famosas canteras de pizarra.", image: "https://lh3.googleusercontent.com/d/14kKobz3f-1LhpckmOcQzeXbzxtkKO3nC" },
    { id: 100, name: "IGLESIA DE NUESTRA SEÑORA DE LA ASUNCIÓN Y DESPOBLADO", category: "Ruinas", coords: "41°07'34.7\"N 4°17'35.6\"W", address: "FUENTES", note: "Restos del nucleus primitivo de población de Fuentes.", image: "https://lh3.googleusercontent.com/d/1L07ZNk3Zoez8JNXJebEalX-9vO2L5eKP" },
    { id: 101, name: "ERMITA DE NUESTRA SEÑORA EL LOSA", category: "Historia", coords: "40°46'20.0\"N 4°15'02.1\"W", address: "EL ESPINAR", note: "Lugar de peregrinación tradicional en la sierra.", image: "https://lh3.googleusercontent.com/d/1OIwxkTCDR0wEf_2iMIuu3ceGKh8JOiyr" },
    { id: 102, name: "CASA PALACIO DEL MARQUÉS DE PERALES", category: "Historia", coords: "40°43'12.1\"N 4°14'50.1\"W", address: "EL ESPINAR", note: "Ejemplo destacado de arquitectura civil nobiliaria.", image: "https://lh3.googleusercontent.com/d/1iH8R0IFLeIWvD-602qcIDQV24eAFG5pw" },
    { id: 103, name: "FÁBRICA DE MADERA", category: "Industrial", coords: "40°44'26.8\"N 4°11'24.1\"W", address: "LA ESTACIÓN DEL ESPINAR", note: "Arquitectura industrial maderera del entorno de la sierra.", image: "https://lh3.googleusercontent.com/d/13F9oPNX3joxwcxzrPXb4tzwIqkQxUFBN" },
    { id: 104, name: "LA VENTA GRANDE", category: "Historia", coords: "40°44'35.0\"N 4°16'19.7\"W", address: "EL ESPINAR", note: "Histórico establecimiento de hospedaje en el puerto del Guadarrama.", image: "https://lh3.googleusercontent.com/d/11CHiLR9mjRIGeDJBwQUG39SjO0VYwiCM" },
    { id: 105, name: "CASA ARMADA DEL MARQUÉS DEL ARCO", category: "Historia", coords: "41°04'41.0\"N 4°19'05.1\"W", address: "ARMUÑA", note: "Finca señorial con torre de vigilancia histórica.", image: "https://lh3.googleusercontent.com/d/13nJp2Z4RHjK9fB45XlcxQqsufq-oC1T7" },
    { id: 106, name: "IGLESIA DE LA VIRGEN DE AGEJAS", category: "Ruinas", coords: "41°03'19.7\"N 4°05'47.8\"W", address: "CABAÑA DE POLENDOS", note: "Restos de la iglesia del antiguo despoblado de Agejas.", image: "https://lh3.googleusercontent.com/d/1KFUnGHPblt2zLnp3hDuyJeFgPQsBIK7V" },
    { id: 107, name: "MOLINO DEL PUENTE", category: "Industrial", coords: "41°08'56.7\"N 4°20'02.1\"W", address: "BERNARDOS", note: "Antiguo ingenio hidráulico para molienda de cereal.", image: "https://lh3.googleusercontent.com/d/1b5-hkFe-2pRcpXBl5FxC2GRpNzsKz8hA" },
    ...
    { id: 111, name: "ESTACIÓN DE TREN", category: "Industrial", coords: "40°59'21.1\"N 4°12'31.0\"W", address: "HONTANARES DE ERESMA", note: "Edificación típica de la red ferroviaria histórica.", image: "https://lh3.googleusercontent.com/d/1lMcYYAjOWE-nBRPwAlw1czyrpTo6smNb" },
    { id: 112, name: "DESPOBLADO DE GUIJASALBAS", category: "Ruinas", coords: "40°49'09.4\"N 4°16'47.8\"W", address: "VALDEPRADOS", note: "Aldea abandonada que conserva el trazado de sus calles y cimientos.", image: "https://lh3.googleusercontent.com/d/1VHOmX3ezEjP804qIesnWHGbcpAWxVZef" },
    { id: 113, name: "ERMITA DE SANTA JUSTA Y SANTA RUFINA", category: "Historia", coords: "41°09'54.8\"N 3°50'38.7\"W", address: "PAJARES DE PEDRAZA", note: "Pequeña iglesia de piedra en un entorno natural.", image: "https://lh3.googleusercontent.com/d/174YYjhwWqLJy7iUQbJ-uNaNuFcJyiZ3Z" },
    { id: 114, name: "MOLINO ALDEASÁS", category: "Industrial", coords: "41°03'44.1\"N 3°57'15.1\"W", address: "TURÉGANO", note: "Maquinaria hidráulica tradicional de la zona de Turégano.", image: "https://lh3.googleusercontent.com/d/18__ASs3ubvjgxXuJNY8r8hGCzGpikTVZ" },
    ...
    { id: 118, name: "FÁBRICAS DE HARINAS Y DE LUZ", category: "Industrial", coords: "41°10'09.1\"N 3°46'56.9\"W", address: "CARBONERO EL MAYOR", note: "Instalaciones que proveyeron de luz y harina a la villa.", image: "https://lh3.googleusercontent.com/d/1hT2JtEn9GVkz9l5ht9r8XtjNCc-z5Qoo" },
    ...
    { id: 120, name: "MOLINO DE LOS FRAILES", category: "Industrial", coords: "41°06'21.4\"N 4°08'46.0\"W", address: "ESCOBAR DE POLENDOS", note: "Antiguo molino propiedad de estamentos religiosos.", image: "https://lh3.googleusercontent.com/d/1ftRj-0-XjrZ-Vk1qbPXR1YKaV_d8lyi6" },
    ...
    { id: 122, name: "MOLINO", category: "Industrial", coords: "41°00'36.7\"N 4°28'33.0\"W", address: "HOYUELOS", note: "Importante muestra de ingeniería hidráulica rural.", image: "https://lh3.googleusercontent.com/d/1lF4dAtkMgsspQxn5rULP5C2fFDT00VPL" },
    { id: 123, name: "ERMITA DE SAN TA ELENA", category: "Historia", coords: "40°48'43.6\"N 4°21'50.4\"W", address: "ITUERO Y LAMA", note: "Santuario románico con excelentes vistas a la sierra.", image: "https://lh3.googleusercontent.com/d/1toIBvL_H6jIDCoxzwUGeUSLeq8ePKuOD" },
    { id: 124, name: "CASERÍO EL SALVADOR", category: "Ruinas", coords: "40°57'16.9\"N 4°31'45.1\"W", address: "JEMENUÑO", note: "Antigua finca ganadera de gran extensión.", image: "https://lh3.googleusercontent.com/d/15aM8WBxLXKJ3mzAVmHedYNc3TqeXbo3D" },
    ...
    { id: 126, name: "CASERÍO DE REDONDA EL NUEVO", category: "Historia", coords: "40°55'41.6\"N 4°21'54.1\"W", address: "MARAZOLEJA", note: "Finca de labranza tradicional con arquitectura típica de ladrillo.", image: "https://lh3.googleusercontent.com/d/1YRqeULAuVe5KXR-UKxtgNUGEdqxhsX1q" },
    { id: 127, name: "ERMITA DE NUESTRA SEÑORA EL ESPINO", category: "Historia", coords: "40°58'07.9\"N 4°33'23.5\"W", address: "MARTÍN MUÑOZ DE LAS POSADAS", note: "Santuario de gran tradición mística y literaria.", image: "https://lh3.googleusercontent.com/d/1Cx3TrFq9ZGtZpX6QZ5gyeaatvoHwMXbe" },
    ...
    { id: 130, name: "DESPOBLADO DE HERREROS", category: "Ruinas", coords: "40°48'25.4\"N 4°13'51.4\"W", address: "OTERO DE HERREROS", note: "Restos de población de tradición metalúrgica.", image: "https://lh3.googleusercontent.com/d/1Ds1eF3cZgglwSjXUhtRruERYN_7JYTmU" },
    { id: 131, name: "MOLINO DE GAMONES", category: "Industrial", coords: "40°55'39.2\"N 4°01'40.4\"W", address: "PALAZUELOS DE ERESMA", note: "Molino que aprovechaba la fuerza del río Eresma.", image: "https://lh3.googleusercontent.com/d/1qBHpcjkxhW7COik2i45KbjY5FAQvFwnH" },
    { id: 132, name: "VENTA DE LOBONES", category: "Historia", coords: "40°57'59.7\"N 4°12'17.1\"W", address: "VALVERDE DEL MAJANO", note: "Histórico alto en el camino del río Eresma.", image: "https://lh3.googleusercontent.com/d/1G0TnraPppiwawiFYAxo2sZwPCfwuFlBZ" },
    { id: 133, name: "CASA DEL TÍO GITANO", category: "Naturaleza", coords: "41°11'24.0\"N 4°12'28.6\"W", address: "PINAR NEGRILLO", note: "Lugar singular envuelto en mitos y leyendas locales.", image: "https://lh3.googleusercontent.com/d/1DkPHLPoa2gpRJI4Kbikmy45kxiChhrHO" },
    ...
    { id: 135, name: "CASA DE LOS BUITRAGO", category: "Historia", coords: "40°56'39.0\"N 4°06'55.6\"W", address: "SEGOVIA", note: "Palacio urbano de gran relevancia histórica.", image: "https://lh3.googleusercontent.com/d/1vIuF7rbr0q91bhRtHR5jrBUkWsDk6ZNQ" },
    { id: 136, name: "CASERÍO DEL TERMINILLO", category: "Historia", coords: "40°57'39.5\"N 4°06'29.6\"W", address: "SEGOVIA", note: "Complejo rural típico de las cercanías de la ciudad.", image: "https://lh3.googleusercontent.com/d/1NtiB9p3fwjpGPHa0MzVgbnvF4FuK6Gw4" },
    { id: 137, name: "PUENTE DEL TESORO", category: "Naturaleza", coords: "40°55'45.0\"N 4°10'54.9\"W", address: "TORREDONDO", note: "Puente envuelto en leyendas de ocultamientos históricos.", image: "https://lh3.googleusercontent.com/d/1DbN2pXwitOz3fpluHD23W7cg08kTOnV-" },
    { id: 138, name: "ESQUILEO DEL PAULAR", category: "Industrial", coords: "40°57'54.3\"N 4°02'15.6\"W", address: "TRESCASAS", note: "Uno de los complejos de esquileo más grandes de la sierra.", image: "https://lh3.googleusercontent.com/d/1gKqTdwLJWGPW4UxSSDv7R6BjqYuxM5n6" },
    { id: 139, name: "MOLINO DE LOBONES", category: "Industrial", coords: "40°58'12.5\"N 4°12'00.5\"W", address: "VALVERDE DEL MAJANO", note: "Molino situado cerca de la emblemática Quinta de Lobones.", image: "https://lh3.googleusercontent.com/d/1HrFwM3y8tIjsmT8klGrqq7UO9InkbGq5" },
    { id: 140, name: "VENTA DE LOBONES", category: "Historia", coords: "40°57'59.7\"N 4°12'17.1\"W", address: "VALVERDE DEL MAJANO", note: "Histórico alto en el camino del río Eresma.", image: "https://lh3.googleusercontent.com/d/1G0TnraPppiwawiFYAxo2sZwPCfwuFlBZ" },
    { id: 141, name: "HORNOS DE CAL DEL ZANCAO", category: "Industrial", coords: "40°47'22.4\"N 4°16'40.0\"W", address: "VEGAS DE MATUTE", note: "Instalaciones para la producción artesanal de cal.", image: "https://lh3.googleusercontent.com/d/1KA3cP8XZHou-Wwi67XJOVehDnhUJ6nGV" },
    { id: 142, name: "DESPOBLADO DE NAVALAVIGA", category: "Ruinas", coords: "40°41'20.7\"N 4°24'29.5\"W", address: "VILLACASTÍN", note: "Punto de paso clave en las cañadas reales de la Mesta.", image: "https://lh3.googleusercontent.com/d/1Jo-d_dn2fAKabykUHn-xg_R_beSmemAP" },
    { id: 143, name: "LAS FALSAS", category: "Industrial", coords: "40°46'32.1\"N 4°24'32.3\"W", address: "VILLACASTÍN", note: "Infraestructura lanera fundamental para la comarca.", image: "https://lh3.googleusercontent.com/d/1IKcIfEjdjs0Gff5Z339ePganprS6s1L9" },
    { id: 144, name: "CASA DEL ZORRO KLIM", category: "Historia", coords: "40°57'14.4\"N 4°10'45.2\"W", address: "ZAMARRAMALA", note: "Lugar ligado a personajes históricos del siglo XX.", image: "https://lh3.googleusercontent.com/d/1Epvuoirgfu8J9tMult2hFzpt38DYmdU0" },
    { id: 145, name: "CHOZO DE LA PORTERA DE LA DEHESA", category: "Historia", coords: "41°02'35.4\"N 3°47'43.4\"W", address: "ALDEALENGUA DE PEDRAZA", note: "Arquitectura tradicional de pastores perfectamente conservada.", image: "https://lh3.googleusercontent.com/d/1Kbcm1V9hwljV5vFOvLJa-SM1mY3KwnJe" },
    { id: 146, name: "MOLINO DE LOS GORICHES", category: "Industrial", coords: "41°10'43.1\"N 3°53'10.3\"W", address: "ARVALILLO DE CEGA", note: "Molino que dominaba el cauce del río Cega en su zona media.", image: "https://lh3.googleusercontent.com/d/1f0-KL5hpGziqxW6l2G4EaC_ZXA0L8nEc" },
    ...
    { id: 148, name: "PRESA Y MOLINO CASTELLANOS", category: "Industrial", coords: "41°04'36.6\"N 3°50'11.0\"W", address: "NAVAFRÍA", note: "Complejo hidráulico de gran importancia local.", image: "https://lh3.googleusercontent.com/d/1iN-hLQdj_WV1tqKKzwB7oDVukX1x6DME" },
    { id: 149, name: "ERMITA DE SAN NICOLÁS", category: "Historia", coords: "41°09'03.2\"N 3°47'10.5\"W", address: "OREJANA", note: "Templo románico rodeado de misterios de la zona mística.", image: "https://lh3.googleusercontent.com/d/132V6RM00LCS639kowAsXTR11_dRG26wE" },
    { id: 150, name: "LA TEJERA DE RAMÓN MARTÍN", category: "Industrial", coords: "41°05'24.5\"N 3°51'18.1\"W", address: "VALLE de SAN PEDRO", note: "Instalaciones artesanales de elaboración de tejas.", image: "https://lh3.googleusercontent.com/d/1Adqxlpsb1FI9MeB99wM0CUCCs7TjQOOw" },
    { id: 151, name: "DESPOBLADO DE ALDEALAFUENTE", category: "Ruinas", coords: "41°14'19.8\"N 3°48'45.5\"W", address: "ALDEALAFUENTE", note: "Huellas de la vida rural medieval desaparecida.", image: "https://lh3.googleusercontent.com/d/1QX6R5uUSqg3ZqC0z9aCvlQ-T39U6Bfvm" },
    ...
    { id: 153, name: "ERMITA DE SANTA ENGRACIA", category: "Historia", coords: "41°19'15.9\"N 3°52'17.7\"W", address: "BURGOMILLODO", note: "Santuario románico con el que soñaban los reyes.", image: "https://lh3.googleusercontent.com/d/10OLAUP_3qzY1d5ZFIp7NHz_gtprU-GKH" },
    { id: 154, name: "MOLINO DE MESA", category: "Industrial", coords: "41°12'21.1\"N 3°58'55.3\"W", address: "CABEZUELA", note: "Ingenio harinero del Cega rodeado de frondosa vegetación.", image: "https://lh3.googleusercontent.com/d/11jnhbuh5odHT8GhxYXGHBRltUGR2krwY" },
    { id: 155, name: "CASILLA DE PEÓN CAMINERO 3", category: "Historia", coords: "41°16'56.8\"N 3°36'09.5\"W", address: "CASTILLEJO DE MESLEÓN", note: "Legado arquitectónico de la red de carreteras del siglo XIX.", image: "https://lh3.googleusercontent.com/d/10VbCmZkcEHRgRazo0caN8C06whywVPfz" },
    { id: 156, name: "TENADAS DE SAN GREGORIO", category: "Historia", coords: "41°24'09.3\"N 3°46'59.0\"W", address: "CASTRO SERRACÍN", note: "Arquitectura pastoril característica del nordeste de la provincia.", image: "https://lh3.googleusercontent.com/d/1aCYtiDBp2buAJeLRFUTkURgu8JfWszxx" },
    { id: 157, name: "ERMITA", category: "Historia", coords: "41°13'12.4\"N 3°35'45.7\"W", address: "CEREZO DE ABAJO", note: "Edificación religiosa sencilla pero de gran valor etnográfico.", image: "https://lh3.googleusercontent.com/d/18K071v4xqITszZoJzeCz0VlpiVdmLRQZ" },
    { id: 158, name: "DESPOBLADO DE CORRAL DE DURATÓN", category: "Ruinas", coords: "41°17'17.5\"N 3°41'45.0\"W", address: "CORRAL DE DURATÓN", note: "Restos de población cercanos al cauce del río místico.", image: "https://lh3.googleusercontent.com/d/1DjbqOZiZXsL8wczZ3EOjCdU-rYR2Zv61" },
    ...
    { id: 161, name: "LA CASETA DEL VAQUERO", category: "Naturaleza", coords: "41°20'26.6\"N 3°58'05.7\"W", address: "NAVALILLA", note: "Pequeño refugio de pastores en el entorno natural de Navalilla.", image: "https://lh3.googleusercontent.com/d/1Hk58veH6EgXtQSRQL9VzNqilKRkNsklR" },
    { id: 162, name: "MOLINOS", category: "Industrial", coords: "41°24'05.6\"N 3°44'25.0\"W", address: "NAVARES DE ENMEDIO", note: "Ingenios hidráulicos muy relevante.", image: "https://lh3.googleusercontent.com/d/1pjz8IrXpgAfww1yvSrD1boYz0JTJ85ig" },
    { id: 163, name: "COLMENARES", category: "Industrial", coords: "41°24'26.7\"N 3°44'47.4\"W", address: "NAVARES DE LAS CUEVAS", note: "Arquitectura tradicional para la explotación de la miel.", image: "https://lh3.googleusercontent.com/d/1uLXPYib7OrGgS1Jl8g1Ukagz77DLiKCW" },
    { id: 164, name: "DESPOBLADO DE CABRERIZOS", category: "Ruinas", coords: "41°12'55.6\"N 3°39'58.3\"W", address: "SANTA MARTA DEL CERRO", note: "Aldea mística que hoy permanece en el recuerdo.", image: "https://lh3.googleusercontent.com/d/165FoofgPTA-zbaGiNuPZC3jIdoO98mBO" },
    { id: 165, name: "ESTACIÓN DE TREN", category: "Industrial", coords: "41°10'50.4\"N 3°33'48.3\"W", address: "SANTO TOMÉ DEL PUERTO", note: "Estructura ferroviaria en la falda de Somosierra.", image: "https://lh3.googleusercontent.com/d/1btse1Lg9DLTbawQL0u0Vx6tmpNWVFlNb" },
    { id: 166, name: "DESPOBLADO DE CASABLANCA", category: "Ruinas", coords: "41°17'36.1\"N 3°50'43.9\"W", address: "SEBÚLCOR", note: "Lugar inhóspito que guarda secretos de antiguos pobladores.", image: "https://lh3.googleusercontent.com/d/1B79S4fUQXkHhbIqkAWz8Htim0soLr9x5" },
    ...
    { id: 168, name: "MOLINO DE LAS CANALEJAS", category: "Industrial", coords: "41°18'14.0\"N 3°45'44.7\"W", address: "SEPÚLVEDA", note: "Molino que aprovechaba las aguas del río Caslilla.", image: "https://lh3.googleusercontent.com/d/1xfJ19fWs1mQ3U55TCljPfy8sVKOFREZD" },
    { id: 169, name: "PUENTE DE TALCANO", category: "Historia", coords: "41°17'42.9\"N 3°45'53.8\"W", address: "SEPÚLVEDA", note: "Puente medieval icónico en la entrada de las Hoces del Duratón.", image: "https://lh3.googleusercontent.com/d/1vstfA7Yx4Y1A15olNsVwDyD-Ds-_KLTZ" },
    { id: 170, name: "APEADERO DE TREN", category: "Industrial", coords: "41°19'54.3\"N 3°36'00.3\"W", address: "TURRUBUELO", note: "Antigua parada de la línea ferroviaria hoy en desuso.", image: "https://lh3.googleusercontent.com/d/1lC9OLqTQVmKlwmroee-rfcX0zg2PmWaP" },
    { id: 171, name: "DESPOBLADO DE BÁLSAMOS", category: "Ruinas", coords: "41°21'28.1\"N 3°43'44.0\"W", address: "URUEÑAS", note: "Asentamiento rural del pasado místico segoviano.", image: "https://lh3.googleusercontent.com/d/130Gl1Y5xbdIJpIWjUHefVHdRh-ITXPTz" },
    { id: 172, name: "LA CASITA ALTA", category: "Naturaleza", coords: "41°21'20.3\"N 3°49'23.2\"W", address: "VALLE DEL TABLADILLO", note: "Lugar de retiro y vistas privilegiadas al valle segoviano.", image: "https://lh3.googleusercontent.com/d/13D8Zoo6fnn0hELq1wRWs02A_MMj6qCM_" },
    { id: 173, name: "TEJERAS", category: "Industrial", coords: "41°21'28.3\"N 3°29'22.0\"W", address: "FRESNO DE CANTESPINO", note: "Legado de la producción cerámica artesanal.", image: "https://lh3.googleusercontent.com/d/11jT_F-pcbP3rLk1kf1RzvkbSbuI2eJav" },
    { id: 174, name: "CONVENTO DE SAN FRANCISCO", category: "Ruinas", coords: "41°25'37.8\"N 3°22'52.3\"W", address: "AYLLÓN", note: "Ruinas majestuosas del convector que visitó San Francisco.", image: "https://lh3.googleusercontent.com/d/1zwZPRX3SyYBKknp3baoGXz_vaSbER3jI" },
    { id: 175, name: "MOLINO SERNA Y DEL VADO", category: "Industrial", coords: "41°27'19.4\"N 3°27'59.0\"W", address: "ALDEALENGUA DE SANTA MARÍA", note: "Complejo de molienda en el noreste de la provincia.", image: "https://lh3.googleusercontent.com/d/1DvXQh9e-LOIF5u2_yBGVvN7DCRz_MwRQ" },
    { id: 176, name: "ESTACIÓN DE TREN", category: "Industrial", coords: "41°25'49.6\"N 3°32'34.9\"W", address: "CAMPO DE SAN PEDRO", note: "Punto de conexión fundamental de la línea de Castilla.", image: "https://lh3.googleusercontent.com/d/1MUIRJyA67EyYrL9YK99rQi0t4GOHDsap" },
    ...
    { id: 180, name: "ERMITA DE SANTA COLOMA", category: "Historia", coords: "41°29'18.2\"N 3°31'22.4\"W", address: "MADERUELO", note: "Joya mística situada junto al embalse de Linares.", image: "https://lh3.googleusercontent.com/d/1OMfy9tuYT80hoiMNnRWRAVjAr5CK_ecZ" },
    { id: 181, name: "ERMITA DE VALDEPERAL", category: "Historia", coords: "41°30'46.2\"N 3°25'39.4\"W", address: "MADERUELO", note: "Lugar de culto y peregrinación mística en el nordeste.", image: "https://lh3.googleusercontent.com/d/1UNukZnFAeMSoJYJEtf7hJYVoFZ5VDtYK" },
    { id: 182, name: "CASILLA DE PEÓN CAMINERO 8", category: "Historia", coords: "41°30'31.8\"N 3°42'50.6\"W", address: "HONRUBIA DE LA CUESTA", note: "Casa de servicio de carreteras del siglo XIX.", image: "https://lh3.googleusercontent.com/d/1UxUalvG6EkH9u-edBs_8bantU4gkZZCn" },
    ...
    { id: 184, name: "EL PAREDÓN DE SAN FÉLIX", category: "Ruinas", coords: "41°29'56.8\"N 3°46'43.0\"W", address: "ALDEHORNO", note: "Restos legendarios de un antiguo santuario medieval.", image: "https://lh3.googleusercontent.com/d/1XoZdBcB0ueBpyMdF5YrV7wxEcvaX5zIf" },
    { id: 185, name: "LAGARES", category: "Industrial", coords: "41°30'57.1\"N 3°46'46.2\"W", address: "ALDEHORNO", note: "Prensas tradicionales para la elaboración del vino.", image: "https://lh3.googleusercontent.com/d/1-0DHlprXsTh92KGHpYkV7mX_esEwzOLz" },
    { id: 186, name: "ERMITA DEL SANTO CRISTO", category: "Historia", coords: "41°23'03.5\"N 3°55'39.8\"W", address: "COBOS DE FUENTIDUEÑA", note: "Lugar de devoción mística segoviana auténtica.", image: "https://lh3.googleusercontent.com/d/1k715IC7GRggdj_STDehqS9Ir7UMH3B1Q" },
    { id: 187, name: "CASTILLO", category: "Historia", coords: "41°32'36.1\"N 3°57'41.0\"W", address: "CUEVAS DE PROVANCO", note: "Fortaleza defensiva con vistas estratégicas al valle.", image: "https://lh3.googleusercontent.com/d/1wMyzDFRc4qK-5NHssypwlFyS2r_5oyRV" },
    { id: 188, name: "LAGARES", category: "Industrial", coords: "41°32'40.5\"N 3°57'39.7\"W", address: "CUEVAS DE PROVANCO", note: "Complejo de bodegas y prensas históricas.", image: "https://lh3.googleusercontent.com/d/1z3ITYeaqHa91hGQDai8KkMNTarAcSGyv" },
    ...
    { id: 190, name: "MONASTERIO DE FRAILES", category: "Ruinas", coords: "41°25'30.1\"N 4°03'46.0\"W", address: "FUENTESAÚCO", note: "Restos monásticos rodeados de tierras de labor.", image: "https://lh3.googleusercontent.com/d/1hfLjWG1gOMskEz3ql-6_Tfa0iKMv5mTu" },
    ...
    { id: 192, name: "CONVENTO DE SAN JUAN", category: "Ruinas", coords: "41°26'58.1\"N 3°58'32.4\"W", address: "FUENTIDUEÑA", note: "Huellas de la espléndida vida religiosa del pasado.", image: "https://lh3.googleusercontent.com/d/1iW_ZHhS6wdiCv66OVIliQdD7-FKYMZfp" },
    { id: 193, name: "ERMITA DE LA SANTA CRUZ", category: "Historia", coords: "41°26'20.9\"N 3°56'52.8\"W", address: "FUENTIDUEÑA", note: "Santuario de gran encanto e historia milenaria.", image: "https://lh3.googleusercontent.com/d/1SIr0gbKhvp5dclA6_S5WsfIWGTQ3MG8E" },
    { id: 194, name: "ERMITA DE VALCALBADO", category: "Historia", coords: "41°27'59.7\"N 3°58'25.8\"W", address: "VALTIENDAS", note: "Famosa ermita que da nombre al paraje místico.", image: "https://lh3.googleusercontent.com/d/1MMgdgrg1-4-mc7dHSCAI15p63ZZQT2At" },
    ...
    { id: 198, name: "MOLINO DE VIENTO EL CUBO", category: "Industrial", coords: "41°23'51.4\"N 4°19'05.9\"W", address: "CUÉLLAR", note: "Molino de viento restaurado que preside la loma.", image: "https://lh3.googleusercontent.com/d/1Gxa0IZYmcbnWi1Xz5xsZsPMIEgnjY11Y" },
    { id: 199, name: "PUENTE DE BARRANCALES", category: "Historia", coords: "41°22'30.3\"N 4°22'00.0\"W", address: "CUÉLLAR", note: "Antiguo puente de piedra que cruza el río Cega.", image: "https://lh3.googleusercontent.com/d/1dA0qvbVU7DRWh2JYhOeFlYdg6DGuBuN2" },
    { id: 200, name: "TORRE DE SANTA MARINA", category: "Historia", coords: "41°24'00.1\"N 4°18'50.6\"W", address: "CUÉLLAR", note: "Único resto visible de la antigua iglesia.", image: "https://lh3.googleusercontent.com/d/1Hbu19_Lj_Q4YPPAWlDJzDL1FpUD6xLBI" },
    ...
    { id: 210, name: "APARTADERO DE TREN", category: "Industrial", coords: "41°13'32.3\"N 4°34'53.6\"W", address: "CIRUELOS DE COCA", note: "Estación mística de la Segovia NO Garleada.", image: "https://lh3.googleusercontent.com/d/19NBbdhEgqpD8UcbHBGunmeZTJsr5_DoB" },
    { id: 211, name: "ESTACIÓN DE TREN", category: "Industrial", coords: "41°12'11.4\"N 4°32'33.7\"W", address: "COCA", note: "Punto de transporte vital para la villa ducal.", image: "https://lh3.googleusercontent.com/d/1NNRCr6E5UAaLSYyaENKSZqrCHk5KF6hL" },
