...
const App = () => {
  ...
  const allPlaces = useMemo(() => [
    ...
    { id: 129, name: "TELÉGRAFO ÓPTICO", category: "Industrial", coords: "40°44'34.0\"N 4°18'01.0\"W", address: "NAVAS DE SAN ANTONIO", note: "Torre vigía de la antigua red de comunicaciones.", history: "Esqueléticas, formidables y desoladas ruinas de una torre fuertemente fortificada y almenada perteneciente a la vital e innovadora 'Línea de Castilla' de telégrafos ópticos (inaugurada en 1846). Diseñada con precisión militar por el célebre ingeniero José María Mathé, esta carísima red de espionaje y rapidísima comunicación estatal permitía a la corte de la reina Isabel II enviar órdenes cifradas secretas desde Madrid hasta Irún en escasas horas. Sus rudos y solitarios 'torreros' vivían penosamente aislados, oteando incesantemente el horizonte con pesados catalejos entre el gélido frío serrano y la constante amenaza de ataques guerrilleros de las facciones carlistas." },
      ...
      {infoModal.show && infoModal.place && (
        <div className="fixed inset-0 z-[2000] items-center justify-center p-4 bg-black/70 backdrop-blur-sm flex animate-fade-in" onClick={() => setInfoModal({ show: false, place: null })}>
          <div className="bg-white rounded-[3rem] w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col shadow-2xl relative text-slate-800" onClick={e => e.stopPropagation()}>
            ...
            {/* Contenido del Modal */}
            <div className="p-8 overflow-y-auto text-left leading-relaxed flex-grow">
            ...
            <div className="p-6 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-[8px] uppercase tracking-[0.2em] font-bold text-slate-400 text-center sm:text-left">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="bg-black text-white px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg hover:bg-indigo-600 transition-all flex items-center gap-2"
              >
                <MapIcon className="w-3 h-3" /> Ver en Mapa
              </a>
            </div>
          </div>
        </div>
