  ...
  return (
    ...
    {showEthnobotany && (
      <div id="ethno-modal" className="fixed inset-0 z-[4000] bg-[#fcfcfd] overflow-y-auto animate-fade-in" onScroll={(e) => setShowEthnoScrollBtn(e.target.scrollTop > 300)}>
        ...
        {/* BOTÓN VOLVER ARRIBA DEL MODAL */}
        {showEthnoScrollBtn && (
            <button 
              onClick={() => document.getElementById('ethno-modal').scrollTo({top: 0, behavior: 'smooth'})} 
              className="fixed bottom-8 right-8 z-[4100] w-14 h-14 bg-black text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all border border-white/10"
            >
