...
const App = () => {
  ...
  const allPlaces = useMemo(() => [
    ...
    { id: 206, name: "FÁBRICA BAUDILIO MESA", category: "Industrial", coords: "41°11'53.0\"N 4°26'09.6\"W", address: "NAVAS DE ORO", note: "Emblemática fábrica de la industria resinera.", history: "Otra 'catedral' de la resina. Esta gigantesca instalación fabril no solo modernizó la química forestal de Segovia introduciendo grandes alambiques y calderas de vapor, sino que también fue pionera en generar empleo estable. Sus propietarios, prohombres de la comarca, tejieron un imperio económico que exportaba las apreciadas resinas de Navas de Oro a los mercados internacionales de Europa." },
    ...
    { id: 208, name: "FÁBRICA DE HARINA", category: "Industrial", coords: "41°15'32.3\"N 4°25'09.2\"W", address: "SAMBOAL", note: "Complejo harinero representative de la zona mística.", history: "Ubicada en una comarca de profundas raíces mudéjares, esta inmensa y sólida fábrica de ladrillo cocido protagonizó la auténtica revolución tecnológica agraria. Sepultando a los románticos pero ineficientes molinos de arroyo, sus modernas y veloces turbinas permitieron moler trigo candeal a escala industrial, logrando dar salida a la colosal producción cerealista de toda la ribera del Pirón." },
